CREATE TABLE {TABLE_PREFIX}user (
  ...
  PRIMARY KEY (id)
) COLLATE utf8_general_ci COMMENT = 'Kloudspeaker users and groups';
...
) COLLATE utf8_general_ci COMMENT = 'Kloudspeaker user auth';
...
CREATE TABLE {TABLE_PREFIX}folder (
  ...
  PRIMARY KEY (id)
) COLLATE utf8_general_ci COMMENT = 'Kloudspeaker published folders';
...
) COLLATE utf8_general_ci COMMENT = 'Kloudspeaker permissions';
...
) COLLATE utf8_general_ci COMMENT = 'Kloudspeaker user published folders';

CREATE TABLE {TABLE_PREFIX}parameter (
  name char(255) NOT NULL,
  value char(255) NOT NULL,
  PRIMARY KEY (name)
) COLLATE utf8_general_ci COMMENT = 'Kloudspeaker parameters';
...
) COLLATE utf8_general_ci COMMENT = 'Kloudspeaker metadata';