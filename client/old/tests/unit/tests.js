    ...
    module('basic')
      ...
      test('login', function () {
		  ...
		  reload().done(function() {
		  	start();
		      ok($("#kloudspeaker-login-name").length, 'username');
		      ok($("#kloudspeaker-login-password").length, 'password');
		      
		      $("#kloudspeaker-login-name").val("user");
		      $("#kloudspeaker-login-password").val("pw");
		      ...
		      $("#kloudspeaker-login-button").trigger("click");
			  ...
			  ok($("#kloudspeaker-mainview-main").length, 'mainview');
	      });
      })
})