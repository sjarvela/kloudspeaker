define(['kloudspeaker/plugins', 'kloudspeaker/events', 'kloudspeaker/session', 'kloudspeaker/service', 'kloudspeaker/filesystem', 'kloudspeaker/ui/formatters', 'kloudspeaker/ui/texts', 'kloudspeaker/ui/controls', 'kloudspeaker/ui/dnd', 'kloudspeaker/ui/dialogs', 'kloudspeaker/dom'], function(plugins, events, session, service, fs, uif, texts, controls, dnd, dialogs, dom) {
    var that = this;
    ...
    this.initialize = function() {
        ...
        var onSession = function() {
            var s = session.get();
            that._softDelete = (s && s.plugins["TrashBin"] && s.data.plugins["TrashBin"]["soft_delete"]);
        };
