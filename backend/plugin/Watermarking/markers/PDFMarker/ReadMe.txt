...
FPDF is released under permissive license (there is no usage restriction), see fpdf/license.txt for more information.

FPDI is released under Apache License v2 (http://www.apache.org/licenses/LICENSE-2.0)