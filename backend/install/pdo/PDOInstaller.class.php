<?php
	...
	class PDOInstaller {
		...
		public function __construct($settings, $type = "install") {
			...
			$this->processor = new KloudspeakerInstallProcessor($type, "pdo", $settings);			
		...
		private function checkInstalled() {
			...
			if (!$this->processor->authentication()->isAdmin()) die("Kloudspeaker Installer requires administrator user");
