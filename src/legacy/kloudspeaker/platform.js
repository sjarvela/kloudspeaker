define(['knockout', 'text', 'durandal/system', 'durandal/viewlocator', 'durandal/composition', 'durandal/binder', 'durandal/plugins/widget'], function(ko, txt, ds, vl, comp, binder, dw) {
    var setup = function() {
        require(['kloudspeaker/settings', 'kloudspeaker/localization', 'kloudspeaker/dom', 'kloudspeaker/ui'], function(settings, loc, dom, ui, uploader, clipboard, dnd) {
            dom.importScript("src/vendor/jquery.tmpl.min.js");
            dom.importScript("src/vendor/jquery-ui.js");

            ui.setup();

            // TODO , 'kloudspeaker/ui/uploader', 'kloudspeaker/ui/clipboard', 'kloudspeaker/ui/dnd'
